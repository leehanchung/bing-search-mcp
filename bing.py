...
# Constants
BING_API_URL = os.environ.get("BING_API_URL", "https://api.bing.microsoft.com/v7.0")
...
@mcp.tool()
async def bing_web_search(query: str, count: int = 10, offset: int = 0, market: str = "en-US") -> str:
    ...
    try:
        ...
        search_url = f"{BING_API_URL}/search"
...
@mcp.tool()
async def bing_news_search(query: str, count: int = 10, market: str = "en-US", freshness: str = "Day") -> str:
    ...
    try:
        ...
        news_url = f"{BING_API_URL}/news/search"
...
@mcp.tool()
async def bing_image_search(query: str, count: int = 10, market: str = "en-US") -> str:
    ...
    try:
        ...
        image_url = f"{BING_API_URL}/images/search"
